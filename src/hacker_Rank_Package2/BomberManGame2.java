...
public class BomberManGame2 {
	...
	public static List<String> bomberMan(int n, List<String> grid) {
        ...
        // Every even second => full grid
        if (n % 2 == 0) {
            return fullGrid(grid);
        }

        // Pattern A (explosion after initial grid)
    ...
    private static List<String> fullGrid(List<String> grid) {
    ...
    private static List<String> explode(List<String> grid) {
        ...
        for (int i = 0; i < rows; i++) {
            finalGrid.add(new String(result[i]));
        }
